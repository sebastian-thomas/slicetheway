...
public class BallOne extends Actor {
	private Sprite spr;
	private Vector2 screenDims;
	private Vector2 oSpriteDims;
	private Vector2 nSpriteDims;
	
	public BallOne(Vector2 screenDims){
		this.screenDims = screenDims;
		spr = new Sprite (new Texture(Gdx.files.internal("b1.png")));
	...
	public void setPosition(){
		int x = (int)(screenDims.x/4 - nSpriteDims.x/2);
